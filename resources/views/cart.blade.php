    ...
    <head>
        ...
        <link href="css/cart.css" rel="stylesheet" />
          <script type="text/javascript"
            ...
            data-client-key="SB-Mid-server-g-iAbH7h1cYuFMS1b11AUmrW">
        </script>
    </head>
    <style>
      .bg-green {
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active text-light" aria-current="page" href="{{ ('home') }}">Home</a></li>
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            <button class="btn btn-outline-dark flex-shrink-0" id="pay-button" type="button">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://dynamic.zacdn.com/KREZERl1z80woKoEThxqRaCNTuM=/fit-in/346x500/filters:quality(90):fill(ffffff)/https://static-id.zacdn.com/p/batik-parisya-8884-3904033-1.jpg" alt="..." />
                            <!-- Product details-->
